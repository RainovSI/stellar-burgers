...
export const getOrders = (state: { orders: TOrdersState }) =>
  state.orders.orders;
export const getTotalOrders = (state: { orders: TOrdersState }) =>
  state.orders.total;
export const getTotalTodayOrders = (state: { orders: TOrdersState }) =>
  state.orders.totalToday;
export const getIsOrderLoading = (state: { orders: TOrdersState }) =>
